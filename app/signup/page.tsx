        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <div className="space-y-3">
              {["Instant AI chart analysis", "Entry, stop loss & take profit levels", "Confidence score & trade grade", "SMC confluence analysis", "Trade journal & watchlist (Pro)"].map((f) => (
            ...
            <p className="font-dm-mono text-[11px] text-[#4b5563] mt-8">
              2,400+ traders are tracking their edge right now
            </p>
          </div>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          >
            ...
            >
              {loading === "trial" ? "Activating trial…" : "Start Pro trial"}
            </button>
...
// ── Step 3: check email ────────────────────────────────────────
function CheckEmail({ email, plan }: { email: string; plan: PlanChoice }) {
  return (
    <div className="min-h-screen bg-[#080a10] text-white flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#00e676]/30 bg-[#00e676]/10 text-[#00e676] text-[10px] font-bold tracking-widest uppercase mb-5">
          {plan === "trial" ? "⚡ Pro trial ready" : "🎯 Free account ready"}
        </div>
        ...
        <div className="rounded-xl px-4 py-3 mb-6 text-sm"
          style={{ background: plan === "trial" ? "rgba(0,230,118,0.06)" : "rgba(255,255,255,0.04)", border: `1px solid ${plan === "trial" ? "rgba(0,230,118,0.2)" : "rgba(255,255,255,0.08)"}` }}>
          {plan === "trial"
